...
const Hero = () => {
  ...
  return (
    <div className="text-center bg-white text-gray-800 py-24 px-6">
      <h1 className="text-5xl md:text-6xl xl:text-7xl font-bold tracking-light mb-12">
      ...
      <div className="flex justify-center items-center space-x-2">
        ...
        <button
          type="button"
          className="inline-block px-6 py-2.5 border border-green-600 text-green-600 font-medium text-xs leading-light uppercase rounded-full shadow-md bg-transparent hover:bg-green-700 hover:text-white"
        >
          Back Projects
        </button>
      </div>
